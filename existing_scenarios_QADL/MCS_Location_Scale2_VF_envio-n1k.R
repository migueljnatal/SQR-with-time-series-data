## MC Simulation -  Location-shift-scale model 2 Galvao (2013) - 50 quantile levels
...
for(s in 1:length(taus)){
  ...
  betas1_rq_bias[s] = mean(A[s,3,]) - (0.5+0.2*qt(taus[s],df=3))
  betas1_cq_bias[s] = mean(C[s,3,]) - (0.5+0.2*qt(taus[s],df=3))
  ...
  betas1_rq_mse[s] = mean((A[s,3,] - (0.5+0.2*qt(taus[s],df=3)))^2)
  betas1_cq_mse[s] = mean((C[s,3,] - (0.5+0.2*qt(taus[s],df=3)))^2)
...
for(s in 1:length(taus)){
  ...
  real_alpha0[s] = 0
  real_alpha1[s] = 0.5
  real_theta1[s] = (0.5+0.2*qt(taus[s],df=3))
  real_theta2[s] = 0.5
